...
const findMin = ((...vals) => vals.reduce((num,nextNum) => nextNum < num ? nextNum : num));
...
const doubleAndReturnArgs = ((arr,...v) => [...arr,...v.map(num => num * 2)]);
...
return [...items].filter(val => [...items].indexOf(val) !== randomIndex);
}
